...
export default function genTestGraph() {
    ...
    let v0 = new Vertex(1, 1, 0, 0, graph);
    let v1 = new Vertex(2, 1, 0, 0, graph);
    let v2 = new Vertex(3, 3, 0, 0, graph);
    let v3 = new Vertex(5, 4, 0, 0, graph);
    let v4 = new Vertex(7, 6, 0, 0, graph);
